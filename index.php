    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center mb-10">
          ...
          <p data-aos="fade-up" data-aos-delay="100">Go Wisata adalah penyedia layanan pemesanan paket private trip , Booking hotel dan villa secara
            online dengan berfokus di wilayah lombok , nusa tenggara barat dan disupport oleh <a href="https://www.instagram.com/finnnnqt_/">Finnnnqt_</a></p>
