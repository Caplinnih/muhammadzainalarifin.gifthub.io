...
<head>
    ...
    <title>Go wisata support by finnnqt</title>
    <link rel="stylesheet" href="../template/vendors/feather/feather.css">
    <link rel="stylesheet" href="../template/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="../template/vendors/css/vendor.bundle.base.css">
    <link rel="stylesheet" href="../template/css/vertical-layout-light/style.css">
    <link rel="shortcut icon" href="gowisata2.png" />
</head>
                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo text-center">
                                <h3><span><img src="Gowisata2.png" style="background-color: aliceblue; border-radius: 100px; height: 40px; width: 40px;" alt=""></span> support by finnnqt</h3>
                            </div>
