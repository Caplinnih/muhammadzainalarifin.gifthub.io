...
<head>
    ...
    <title>Go Wisata support by finnnnqt</title>
    <meta content="Go wisata support by finnnnqt" name="description">
    <meta content="Go wisata support by finnnnqt" name="keywords">
    <link href="assets/img/gowisata2.png" rel="icon">
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-5 col-md-12 footer-contact text-center text-md-start">
                    <h4>Kontak Kami</h4>
                    <p>
                        <strong>Phone:</strong> 085338421205<br>
                        <strong>Email:</strong> muhammadzarifin@gmail.com<br>
                    </p>
                </div>
            </div>
        </div>
